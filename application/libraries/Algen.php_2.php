...
class Algen
{
    ...
    public $populasi_breeding_crossover_selected = [];
    ...
    */
    public function get_random_local($individu, $kelas, $timespace, $makul_grup, $waktudistinct_grup, $period_waktu, $id_timespace_cek = null)
    {
        /*
