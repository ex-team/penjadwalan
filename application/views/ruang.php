              ...
              <table class="table table-striped table-bordered">
                 ...
                 <?php
                   ...
                   <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url() . 'web/ruang_edit/' .$ruang->id_ruang;?>" class="btn btn-small"><i class="icon-pencil"></i></a>
                        <a href="<?php echo base_url() . 'web/ruang_delete/' .$ruang->id_ruang;?>" class="btn btn-small" onClick="return confirm('Anda yakin ingin menghapus data ini?')" ><i class="icon-trash"></i></a>
                      </td>
                   </tr>
                 <?php $i++;} ?>
