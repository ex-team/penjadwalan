            ...
            <div class="col-md-4">
                <h3>Jam</h3>
                    ...
                    <div class="col-md-8 text-right">
                        <a href="<?php echo base_url("data_jam/tambah") ?>" class="btn btn-primary"><i class="fa fa-plus"></i>Tambah Jam</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        <?php foreach ($jam as $key => $value): ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo $value["nama_jam"]; ?></td>
                                <td class="text-center"><?php echo $value["keterangan"]; ?></td>
                            
                                <td class="text-center">
                                    <a href="<?php echo base_url("data_jam/ubah/".$value['id_jam'])?>" class="btn btn-warning btn-sm">
