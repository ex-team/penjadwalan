   ...
   <div class="container-fluid">
      <div class="row-fluid">
        ...
        <form id="tab" method="POST" >
            <label>NIP</label>
            <input id="NIP" type="text" value="<?php echo set_value('NIP');?>" name="NIP" class="input-xlarge" />
            
            <label>Nama</label>
            <input id="nama_guru" type="text" value="<?php echo set_value('nama_guru');?>" name="nama_guru" class="input-xlarge" />
