...
class Pso extends CI_Controller
{
    ...
    private $waktu_dosen = [[]];
    private $jenis_mk = []; //reguler or praktikum
    ...
    public function __construct($jenis_semester, $tahun_akademik, $populasi, $c1, $c2, $w, $kode_jumat, $range_jumat, $kode_dhuhur)
    {
        parent::__construct();
    ...
    public function StartCrossOver()
    {
        ...
        for ($i = 0; $i < $this->populasi; $i += 2) {
            ...
            if (floatval($cr) < floatval($this->crossOver)) {
                //ketika nilai random kurang dari nilai probabilitas pertukaran maka jadwal mengalami prtukaran
    ...
    public function Mutasi()
    {
        ...
        for ($i = 0; $i < $this->populasi; $i++) {
            //Ketika nilai random kurang dari nilai probalitas Mutasi, maka terjadi penggantian komponen
