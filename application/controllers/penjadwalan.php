...
class Penjadwalan extends CI_Controller
{
    ...
    public function kelas()
    {
        ...
        $param['url_proses_jadwal_pso'] = $this->bantu->getRootAddress().'index.php/penjadwalan/proses_jadwal_pso';
    ...
    public function proses_jadwal_pso()
    {
        /**********processRequest**********/

        $param['url_kelas'] = $this->bantu->getRootAddress().'index.php/penjadwalan/kelas';
        $param['url_submit'] = $this->bantu->getRootAddress().'index.php/proses_penjadwalan_pso/lakukan_penjadwalan';
        $param['display'] = 'style="display:none"';

        $template_konten = 'penjadwalan/proses_jadwal_view_pso';
    ...
    public function jadwal_kuliah()
    {
        ...
        $grup_hari = ['senin', 'selasa', 'rabu', 'kamis', 'jumat'];
        $waktu_transform = [];
