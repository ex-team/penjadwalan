...
class Proses_pengelolaan extends CI_Controller
{
    ...
    public function del_matakuliah()
    {
        $sts = true;
        $this->db->trans_start();
    ...
    public function simpan_program_studi()
    {
        $sts = true;
        $this->db->trans_start();
    ...
    public function del_program_studi()
    {
        $sts = true;
        $this->db->trans_start();
    ...
    public function simpan_waktu_dosen()
    {
        $sts = true;
        $this->db->trans_start();
    ...
    public function del_program_studi_on_makul_prodi()
    {
        $sts = true;
        $this->db->trans_start();
    ...
    public function del_waktu_dosen()
    {
        $sts = true;
        $this->db->trans_start();
